...
const UserHome = () => {
  ...
  return (
    <div className="px-4 sm:px-8 md:px-12 lg:px-24 py-5">
        ...
        <div className="mb-8 sm:mb-12">
          ...
          <div className="flex gap-3 sm:gap-4 md:gap-6 overflow-x-auto pb-4">
            {localFarmers.map((farmer) => (
              <div
                key={farmer._id}
                className="border rounded-lg shadow-md p-3 sm:p-4 min-w-[180px] sm:min-w-[250px] bg-white cursor-pointer"
              ...
              >
                {farmer.profilePicture ? (
                  <CardMedia
                    ...
                    sx={{ height: "150px", sm: "200px", objectFit: "contain" }}
                  />
                ) : (
                  <Box
                    display="flex"
                  ...
                  >
                    <AccountCircleIcon
                      sx={{ fontSize: 80, sm: 100, color: "grey.500" }}
                    />
                  </Box>
                )}
